...
public class  Spring extends Shape3D
{
    ...
    **/
        ...
        Appearance springAppearance)
    {
        ...
        springGeometry.setCapability( QuadArray.ALLOW_COLOR_READ );
        springGeometry.setCapability( QuadArray.ALLOW_COLOR_WRITE );
        springGeometry.setCapability( QuadArray.ALLOW_COORDINATE_READ );
        springGeometry.setCapability( QuadArray.ALLOW_COORDINATE_WRITE );
        springGeometry.setCapability( QuadArray.ALLOW_COUNT_READ );
        ...
        this.setGeometry(springGeometry);
        this.setAppearance(springAppearance);
