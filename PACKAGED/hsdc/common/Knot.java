 ...
 */
public class Knot extends Shape3D
{
    ...
    private QuadArray knotGeometry;
    ...
    **/
        ...
        Appearance knotAppearance)
    {
        ...
        knotGeometry.setCapability( QuadArray.ALLOW_COLOR_READ );
        knotGeometry.setCapability( QuadArray.ALLOW_COLOR_WRITE );
        knotGeometry.setCapability( QuadArray.ALLOW_COORDINATE_READ );
        knotGeometry.setCapability( QuadArray.ALLOW_COORDINATE_WRITE );
        knotGeometry.setCapability( QuadArray.ALLOW_COUNT_READ );
        ...
        this.setGeometry(knotGeometry);
        this.setAppearance(knotAppearance);
